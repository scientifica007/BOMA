...
def main() -> int:
    ...
    require(generation == "BOMA-AUTONOMY-008", "dry run requires Generation 008 bootstrap")
...
Return {{"close":true,"carry_forward":["technical JSON pipeline works"]}}.""",
    ...
    record = {
        "schema": "BOMA-AUTONOMY-PRESTART-DRYRUN-008",
    ...
    print("BOMA Generation-008 pre-START synthetic technical dry run: PASS")
    return 0
