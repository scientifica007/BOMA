...
def main() -> int:
    ...
    require(generation == "BOMA-AUTONOMY-004", "dry run requires Generation 004 bootstrap")
...
Return {{"close":true,"carry_forward":["technical JSON pipeline works"]}}.""",
    ...
    record = {
        "schema": "BOMA-AUTONOMY-PRESTART-DRYRUN-004",
    ...
    print("BOMA Generation-004 pre-START synthetic technical dry run: PASS")
    return 0
